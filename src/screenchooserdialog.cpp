...
//    m_dialog->screensTab->setEnabled(types & ScreenCastPortal::Monitor);
    m_dialog->tabWidget->setTabEnabled(m_dialog->tabWidget->indexOf(m_dialog->windowsTab),types & ScreenCastPortal::Window);
    m_dialog->tabWidget->setTabEnabled(m_dialog->tabWidget->indexOf(m_dialog->screensTab),types & ScreenCastPortal::Monitor);
