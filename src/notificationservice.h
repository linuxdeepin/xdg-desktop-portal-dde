 ...
 * Command line was: qdbusxml2cpp -c NotificationService -p notificationservice org.freedesktop.Notifications.xml
 *
 ...
 */
class NotificationService: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NotificationService(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
...
namespace org {
  namespace freedesktop {
    typedef ::NotificationService Notifications;
  }
}
#endif
