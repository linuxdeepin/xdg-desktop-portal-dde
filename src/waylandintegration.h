...
#ifndef XDG_DESKTOP_PORTAL_DDE_WAYLAND_INTEGRATION_H
#define XDG_DESKTOP_PORTAL_DDE_WAYLAND_INTEGRATION_H
...
#endif // XDG_DESKTOP_PORTAL_DDE_WAYLAND_INTEGRATION_H
